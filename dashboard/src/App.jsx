    ...
    <div className="app">
      <header className="header">
        <div className="header-left">
          ...
          <span className="header-label">agent console</span>
        </div>
          ...
          <div className="landing">
            <div className="landing-inner">
              <div className="landing-left">
                <p className="landing-pre">AUTONOMOUS BUILD PIPELINE</p>
                <h1 className="landing-title">
                  One prompt in.<br />
                  A running app out.
                </h1>
                <p className="landing-desc">
                  A chain of focused agents — planning, architecture,
                  code, review, and self-repair — hands off work
                  step by step until your spec becomes a deployed build.
                </p>
              </div>
      ...
      <footer className="footer">
        <span>&copy; {new Date().getFullYear()} Vaibhav Pandey — DevGraph</span>
      </footer>
    </div>
  );
}
